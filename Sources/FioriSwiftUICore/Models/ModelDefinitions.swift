...
/// Deprecated ActivityItems
@available(*, unavailable, renamed: "_ActivityItemsModel", message: "Will be removed in the future release. Please create ActivityItems with other initializers instead.")
