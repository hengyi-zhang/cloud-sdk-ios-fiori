...
public struct WelcomeScreenSubtitleStyle: WelcomeScreenStyle {
    let style: any SubtitleStyle
...
public extension WelcomeScreenStyle where Self == WelcomeScreenSubtitleStyle {
    static func subtitleStyle(_ style: some SubtitleStyle) -> WelcomeScreenSubtitleStyle {
        WelcomeScreenSubtitleStyle(style: style)
    }

    static func subtitleStyle(@ViewBuilder content: @escaping (SubtitleConfiguration) -> some View) -> WelcomeScreenSubtitleStyle {
        let style = AnySubtitleStyle(content)
        return WelcomeScreenSubtitleStyle(style: style)
    }
}
